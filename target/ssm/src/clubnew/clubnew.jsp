				...
				<div class="layui-card">
					...
					<div class="layui-card-body">
						...
						<table class="layui-hide" id="test-table-operate"
							...
							<thead>
							    <tr>
							      <th lay-data="{field:'clubnid'">ID</th>
							      <th lay-data="{field:'clubnewtitle'">标题</th>
							      <th lay-data="{field:'clubnewcontent'">内容</th>
							    </tr>
							</thead>
						</table>
				...
				.use(
						...
						function() {
							...
							table.on('tool(test-table-operate)', function(obj) {
								var data = obj.data;
								if (obj.event === 'detail') {
									layer.msg('ID：' + data.clubnid + ' 的查看操作');
								} else if (obj.event === 'del') {
									layer.confirm('真的删除行么', function(index) {
										obj.del();
										$.getJSON("delclubnew", {
											"clubnid" : data.clubnid
											}, function(data) {
										})
										layer.close(index);
									});
											...
											.open({
												type : 2,
												title : '修改公告',
												content : 'listform1.jsp?clubnid='+data.clubnid+'',
												maxmin : true,
												area : [ '550px', '550px' ],
												btn : [ '确定', '取消' ],
