                ...
                <TABLE cellSpacing=0 cellPadding=3 width=165 align=center border=0>
                    ...
                    <TR>
                        <TD class=mainMenu onClick="MenuDisplay('table_1');"><SPAN
                                class=span id=table_1Span>＋</SPAN> 一卡通管理
                        </TD>
                    </TR>
                    <TR>
                        <TD>
                            <TABLE id=table_1 style="DISPLAY: none" cellSpacing=0
                                ...
                                <TR>
                                    <TD class=menuSmall><A class=style2
                                                           href="${pageContext.request.contextPath}/studentinformation"
                                                           target=main>－ 一卡通信息列表</A></TD>
                                </TR>
                                <TR>
                                    <TD class=menuSmall><A class=style2
                                                           href="${pageContext.request.contextPath}/make/make"
                                                           target=main>－ 补办管理</A></TD>
                                </TR>
                    ...
                    <TR>
                        <TD class=mainMenu onClick="MenuDisplay('table_2');"><SPAN
                                class=span id=table_2Span>＋</SPAN> 课程管理
                        </TD>
                    </TR>
                    <TR>
                        <TD>
                    ...
                    <TR>
                        <TD>
                            <TABLE id=table_5 style="DISPLAY: none" cellSpacing=0
                                ...
                                <TR>
                                    <TD class=menuSmall><A class=style2
                                                           href="${pageContext.request.contextPath}/evaluate/allEvaluate"
                                                           target=main>－学生评价</A></TD>
                                </TR>
                                <TR>
                                    <TD class=menuSmall><A class=style2
                                                           href="${pageContext.request.contextPath}/achievement/allAchievement"
                                                           target=main>－成绩管理</A></TD>
                                </TR>
                                <TR>
                                    <TD class=menuSmall><A class=style2
                                                           href="${pageContext.request.contextPath}/mian/allMian"
                                                           target=main>－免修申请</A></TD>
                                </TR>
                                <TR>
                                    <TD class=menuSmall><A class=style2
                                                           href="${pageContext.request.contextPath}/exam/allExam"
                                                           target=main>－考试安排</A></TD>
                                </TR>
                                <TR>
                                    <TD class=menuSmall><A class=style2
                                                           href="${pageContext.request.contextPath}/rexam/allRexam"
                                                           target=main>－重考申请</A></TD>
                                </TR>
                                <TR>
                                    <TD class=menuSmall><A class=style2
                                                           href="${pageContext.request.contextPath}/rebuild/allRebuild"
                    ...
                    <TR>
                        <TD class=mainMenu onClick="MenuDisplay('table_4');"><SPAN
                                class=span id=table_4Span>＋</SPAN> 个人课程
                        </TD>
                    </TR>
                    <TR>
                        <TD>
                            <TABLE id=table_4 style="DISPLAY: none" cellSpacing=0
                                ...
                                <TBODY>
                                <TR>
                                    <TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath}/selfCourse.jsp"
